...
const manufacturersArray = Array.isArray(filteredManufacturers) ? filteredManufacturers : [filteredManufacturers];

  return (
    <div className='search-manufacturer'>
        <Combobox value={manufacturer} onChange={setManufacturer}>
            <div className='relative w-full visible '>
                <Combobox.Button className='relative top-[42px]'>
