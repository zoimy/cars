		...
		<div className='car-card group'>
			...
			<div className='relative flex w-full mt-2'>
				...
				<div className='car-card__btn-container'>
					<CustomButton btnType='button' title='View More' containerStyles='w-full py-[16px] rounded-full bg-primary-blue' textStyles='text-white text-[14px] leading-[17px] font-bold' rightIcon='/right-arrow.svg' handleClick={() => setIsOpen(true)}/>
				</div>
